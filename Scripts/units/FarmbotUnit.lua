...
function FarmbotUnit.server_onCreate( self )
	...
	if self.saved.stats == nil then
		self.saved.stats = { hp = 16, maxhp = 16 } --1600
	end
	...
	self.attackState01.damage = 1 --10
	...
	self.attackState02.damage = 3 --35
	...
	self.attackState03.damage = 3 --35
	...
	self.attackPartState.damage = 6 --60
	...
	self.attackState05.damage = 3 --35
