...
function HaybotUnit.server_onCreate( self )
	...
	if self.saved.stats == nil then
		self.saved.stats = { hp = 10, maxhp = 10 } --100
	end
	...
	self.attackState01.damage = 3 --30
	...
	self.attackState02.damage = 2 --20
	...
	self.attackState03.damage = 2 --20
	...
	self.attackStateSprint01.damage = 2 --20
